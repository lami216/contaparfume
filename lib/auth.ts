...
export const CAPABILITIES = [
  ...
  "expenses.view","expenses.create","expenses.edit","expenses.delete","reports.view","perfume.divisions.view","perfume.divisions.manage","settings.view","settings.branding.manage","settings.backup.manage","settings.legacy.import","settings.users.manage",
] as const;
