...
<<<<<<< /tmp/tmpfwt88_4k/ours
      <button className="soft" type="button" onClick={() => setCategoryDialogOpen(true)}><Plus /> {tr("إضافة فئة")}</button><button className="primary" onClick={() => openForm(null)}><Plus />  {tr("إضافة منتج")}</button>
=======
...
<<<<<<< /tmp/tmpfwt88_4k/ours
  ...
  const footerMetrics=result?buildReportFooterMetrics({type,result,productFiltered:Boolean(productId||categoryId),partyType:partyTypeFilter}):[];
