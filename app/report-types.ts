...
export interface OverviewBreakdownRow { id:string; documentId:string; number:string; occurredAt:string; kind:"sale"|"decant-sale"|"return"|"purchase"|"decant-purchase"|"expense"; value:number }
